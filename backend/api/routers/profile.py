...
from api.dependencies import DBSession, GeoProvider, PhotoPresignerDep, RedisClient, S3Client, require_bot_auth
...
async def profile_me(
    ...
    data = await profile_svc.get_profile_me(session, body.telegram_id, presigner)
